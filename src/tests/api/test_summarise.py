def test_summarise_success(client, mock_chat_openai_agenerate, create_mock_llm_result):
    mock_text = "This is a summary."
...
def test_summarise_streaming_chunks(
...
def test_summarise_invalid_text(client, mock_chat_openai_agenerate):
    test_text = ""
    response = client.post(
        "/api/v1/summarise",
        json={"text": test_text},
